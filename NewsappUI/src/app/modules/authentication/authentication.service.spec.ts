...
describe('AuthenticationService', () => {
  ...
  const testForRegister = "http://localhost:8073/favouriteservice/api/v1/favouriteservice/register";
  // this.springRegisterEndPoint = "http://localhost:8073/favouriteservice/api/v1/favouriteservice/register"; 
  const testForLogin = "http://localhost:8073/userservice/api/v1/userservice/login";
